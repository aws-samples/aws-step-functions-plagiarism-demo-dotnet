...
var projects = new []
{
    sourceDir.Path + "AdminActionTask/AdminActionTask.csproj",
    sourceDir.Path + "RegisterIncidentTask/RegisterIncidentTask.csproj",
    sourceDir.Path + "ResolveIncidentTask/ResolveIncidentTask.csproj",
    sourceDir.Path + "ScheduleExamTask/ScheduleExamTask.csproj",
    sourceDir.Path + "SendNotificationTask/SendNotificationTask.csproj",
    sourceDir.Path + "ValidateExamTask/ValidateExamTask.csproj"
};
